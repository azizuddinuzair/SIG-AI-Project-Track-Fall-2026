...
def load_data_and_models():
    ...
    models_folder = pathlib.Path(__file__).resolve().parents[1] / "reports" / "clustering_analysis"
...
def main():
    ...
    # Save to file
    output_dir = pathlib.Path(__file__).resolve().parents[1] / "reports" / "clustering_analysis"
